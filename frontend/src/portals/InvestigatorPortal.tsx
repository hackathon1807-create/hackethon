...
const InvestigatorPortal = ({ onBack, hideHeader }: InvestigatorPortalProps) => {
    ...
    const handleTrace = async () => {
        ...
        try {
            ...
            setTraceResult({
                ...
                error: "Cannot connect to Blood Moon backend at http://localhost:8000. Start the backend server to enable real OSINT investigation.",
                cnn_analysis: null,
                osint_report: null,
    ...
    const handleDownloadFIR = () => {
        ...
        const content = `BLOOD MOON CLASSIFIED INTELLIGENCE PLATFORM
${'═'.repeat(60)}
...
${'═'.repeat(60)}
FORENSIC INTEGRITY: This report was generated by Blood Moon v4.0
